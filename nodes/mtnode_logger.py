...
class XSensDriver(object):
    ...
    def spin_once(self):
        ...
        if self.pub_gps:
            ...
            #print("gps",message_converter.convert_ros_message_to_dictionary(self.gps_msg))
            #print("XXXXXgps",message_converter.convert_ros_message_to_dictionary(self.xgps_msg))
        if self.pub_vel:
