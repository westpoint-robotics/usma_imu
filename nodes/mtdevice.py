    ...
    def parse_MTData2(self, data):
        ...
        while data:
            try:
                ...
                # print hex(data_id),size,hex(data_id&0x0003)
                if (data_id&0x0003) == 0x3:
                    float_format = 'd'
                elif (data_id&0x0003) == 0x0:
                    float_format = 'f'
                else:
                    raise MTException("Fixed point precision not supported. Use MT Manager to change to floating point 32-bit")
